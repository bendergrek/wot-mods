    ...
    "textFields": [
	 ...
	 // Text field with the name of the tank.
      // Текстовое поле с названием танка.
            ...
            {
              "name": "Tank HP",              // название текстового поля, ни на что не влияет
              "visible": true,                // false - не отображать
              "x": 0,                         // положение по оси X
				...
				// Текстовое поле со шкалой опасности игрока
            {
              ...
              "shadow": {                     // параметры тени
               ...
               "format": "<img src='img://gui/scaleform/skill/{{c:wn8}}.png' width='55' height='2'>" // формат текста. См. описание макросов в readme-ru.txt
            },
     ...
     // Текстовое поле с названием танка
				...
				// Текстовое поле со шкалой опасности игрока
            {
              ...
              "shadow": {                     // параметры тени
               ...
               "format": "<img src='img://gui/scaleform/skill/{{c:wn8}}.png' width='50' height='2'>" // формат текста. См. описание макросов в readme-ru.txt
            },
