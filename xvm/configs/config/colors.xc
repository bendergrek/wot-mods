 ...
 */
{
  ...
  "def": {
    ...
    "sqattack": "0xFFB964", // Цвет урона совзводного	
    "ensqattack": "0x6fd457", // Цвет урона по созводному
  ...
  "colors": {
    ...
    "damage": {
      ...
      "squadman_ally_hit":          ${"def.sqattack"},
      "squadman_ally_kill":         ${"def.sqattack"},
      "squadman_ally_blowup":       ${"def.sqattack"},
      "squadman_squadman_hit":      ${"def.sqattack"},
      "squadman_squadman_kill":     ${"def.sqattack"},
      "squadman_squadman_blowup":   ${"def.sqattack"},
      "squadman_enemy_hit":         ${"def.sqattack"},
      "squadman_enemy_kill":        ${"def.sqattack"},
      "squadman_enemy_blowup":      ${"def.sqattack"},
      "squadman_allytk_hit":        ${"def.sqattack"},
      "squadman_allytk_kill":       ${"def.sqattack"},
      "squadman_allytk_blowup":     ${"def.sqattack"},
      "squadman_enemytk_hit":       ${"def.sqattack"},
      "squadman_enemytk_kill":      ${"def.sqattack"},
      "squadman_enemytk_blowup":    ${"def.sqattack"},
      "enemy_ally_hit":             ${"def.al"},
      "enemy_ally_kill":            ${"def.al"},
      "enemy_ally_blowup":          ${"def.al"},
      "enemy_squadman_hit":         ${"def.ensqattack"},
      "enemy_squadman_kill":        ${"def.ensqattack"},
      "enemy_squadman_blowup":      ${"def.ensqattack"},
      ...
      "unknown_squadman_hit":       ${"def.ensqattack"},
      "unknown_squadman_kill":      ${"def.ensqattack"},
      "unknown_squadman_blowup":    ${"def.ensqattack"},
