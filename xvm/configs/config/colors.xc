 ...
 */
{
  ...
  "colors": {
    ...
    "damage": {
      ...
      "enemy_squadman_hit":         ${"def.en_sq"},
      "enemy_squadman_kill":        ${"def.en_sq"},
      "enemy_squadman_blowup":      ${"def.en_sq"},
      ...
      "unknown_squadman_hit":       ${"def.en_sq"},
      "unknown_squadman_kill":      ${"def.en_sq"},
      "unknown_squadman_blowup":    ${"def.en_sq"},
