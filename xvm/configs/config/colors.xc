 ...
 */
{
  ...
  "colors": {
    ...
    "damage": {
      ...
      "squadman_enemy_hit":         ${"def.pro"},
      "squadman_enemy_kill":        ${"def.pro"},
      "squadman_enemy_blowup":      ${"def.pro"},
      "squadman_allytk_hit":        ${"def.pro"},
      "squadman_allytk_kill":       ${"def.pro"},
      "squadman_allytk_blowup":     ${"def.pro"},
      "squadman_enemytk_hit":       ${"def.pro"},
      "squadman_enemytk_kill":      ${"def.pro"},
      "squadman_enemytk_blowup":    ${"def.pro"},
